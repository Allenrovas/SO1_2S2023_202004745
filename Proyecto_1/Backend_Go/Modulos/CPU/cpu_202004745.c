...
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("Modulo CPU, Proyecto 1 - Sistemas Operativos 1");
MODULE_AUTHOR("Allen Román");


//Modulo que lee el archivo cpu_202004745, el cual contiene la información de la CPU
...
{
    proc_create("cpu_202004745", 0, NULL, &operaciones);
...
{
    remove_proc_entry("cpu_202004745", NULL);
